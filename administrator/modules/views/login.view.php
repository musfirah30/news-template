...
<head>
    <meta charset="utf-8" />
    <title>SEPUTAR TEKNIK UNHAS</title>
    ...
    <form class="form-signin" method="post">
        ...
        <div class="form-group">
            <div class="text-center text-header">
                <img src="<?php echo PATH; ?>resources/images/Unhas.jpg" style="width:75px;" alt="Unhas">
                <h1>SEPUTAR TEKNIK UNHAS</h1>
        ...
        <div class="form-group">
            ...
            <input type="text" id="input-username" name="username" class="form-control" required autofocus>
        </div>
        <div class="form-group">
